updated makenumeric, proptable, and started on readme. also added more t…
…ests for each function
765768f
README.md
@@ -1 +1,139 @@
# asianamsurvey
...
## Overview
This package provides tools for analyzing and visualizing survey data. It was developed to support data management and analysis for survey research. Specifically designed to handlesurvey responses, it offers robust data cleaning and visualization capabilities.
